...
Use F8 to show/hide the GUI (after you click anywhere in the rendering area to give focus to the canvas) and WASD to move. Press B (or use the "Bather view" checkbox in the GUI) to drop into the water at swimmer eye-height and float on the waves.
